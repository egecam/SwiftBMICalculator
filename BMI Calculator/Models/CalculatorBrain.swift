...
//  BMI Calculator
//
//  Created by Ege Çam on 10.05.2022.
...
struct CalculatorBrain {
    ...
    func getBMIValue() -> String {
        let bmiOneDecimal = String(format: "%1.f", bmi?.value ?? 0.0)
    ...
    mutating func calculateBMI(height: Float, weight: Float) {
        ...
        if bmiValue < 18.5 {
            ...
            bmi = BMI(value: bmiValue, advice: "Your'e going well!", color: #colorLiteral(red: 0.721568644, green: 0.8862745166, blue: 0.5921568871, alpha: 1))
        } else {
